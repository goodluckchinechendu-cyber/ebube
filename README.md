...
**Web / API:** push to GitHub; Railway builds Flutter web in Docker and deploys.
...
Public page: https://ebubeconnect.com/downloads/

**CLI fallback** for the whole site (local Flutter web build + `railway up`):
